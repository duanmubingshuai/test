...
#define MS_PS_RECORD_CORE_MODULES_OFFSET           (MS_PS_RECORD_PROVISIONER_ADDR_OFFSET + MS_PS_RECORD_PROVISIONER_ADDR_MAXSIZE)
...
#define MS_PS_ACCESS_MAX_RECORDS       11
...
//extern MS_ACCESS_MODEL_TYPE ms_access_model_list[MS_CONFIG_LIMITS(MS_ACCESS_MODEL_COUNT)];
