...
static DECL_CONST UINT32 generic_admin_property_server_opcode_list[] =
{
...
static MS_ACCESS_MODEL_HANDLE   generic_admin_property_server_model_handle;
static MS_GENERIC_PROPERTY_SERVER_CB       generic_admin_property_server_appl_cb;
...
)
{
    ...
    GENERIC_ADMIN_PROPERTY_SERVER_TRC(
        "[GENERIC_ADMIN_PROPERTY] Registered Element Handle 0x%02X\n", element_handle);
    /* Configure Model */
    model.model_id.id = MS_MODEL_ID_GENERIC_ADMIN_PROPERTY_SERVER;
    model.model_id.type = MS_ACCESS_MODEL_TYPE_SIG;
    model.elem_handle = element_handle;
    /* Register Callbacks */
    model.cb = generic_admin_property_server_cb;
    model.pub_cb = generic_admin_property_server_publish_timout_cb;
    /* List of Opcodes */
    model.opcodes = generic_admin_property_server_opcode_list;
    model.num_opcodes = sizeof(generic_admin_property_server_opcode_list) / sizeof(UINT32);
    ...
    generic_admin_property_server_appl_cb = appl_cb;
    /* TODO: Remove */
    generic_admin_property_server_model_handle = *model_handle;
    return retval;
}
...
)
{
    ...
    marker = 0;
    GENERIC_ADMIN_PROPERTY_SERVER_TRC(
        "[GENERIC_ADMIN_PROPERTY_SERVER] State Update.\n");
    ...
    case MS_STATE_GENERIC_ADMIN_PROPERTY_T:
    {
        ...
        param_p = (MS_STATE_GENERIC_ADMIN_PROPERTY_STRUCT*)current_state_params->state;
        ...
        GENERIC_ADMIN_PROPERTY_SERVER_debug_dump_bytes(buffer, marker);
        /* Set Opcode */
        opcode = MS_ACCESS_GENERIC_ADMIN_PROPERTY_STATUS_OPCODE;
    }
    break;
    ...
    case MS_STATE_GENERIC_ADMIN_PROPERTY_IDS_T:
    {
        ...
        /* Set Opcode */
        opcode = MS_ACCESS_GENERIC_ADMIN_PROPERTIES_STATUS_OPCODE;
    }
    break;

    default:
    {
        GENERIC_ADMIN_PROPERTY_SERVER_ERR(
...
MODEL_OPCODE_HANDLER_EMPTY_DEF(generic_admin_properties_get_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(generic_admin_property_get_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(generic_admin_property_set_handler)
...
*/
API_RESULT generic_admin_property_server_cb
(
...
)
{
    ...
    MS_STATE_GENERIC_ADMIN_PROPERTY_STRUCT    param;
    ...
    GENERIC_ADMIN_PROPERTY_SERVER_TRC(
        "[GENERIC_ADMIN_PROPERTY_SERVER] Callback. Opcode 0x%04X\n", opcode);
    GENERIC_ADMIN_PROPERTY_SERVER_debug_dump_bytes(data_param, data_len);

    switch(opcode)
    {
    case MS_ACCESS_GENERIC_ADMIN_PROPERTY_SET_UNACKNOWLEDGED_OPCODE: /* Fall Through */
    case MS_ACCESS_GENERIC_ADMIN_PROPERTY_SET_OPCODE:
    {
        MODEL_OPCODE_HANDLER_CALL(generic_admin_property_set_handler);
        /* Set Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_SET;

        if (MS_ACCESS_GENERIC_ADMIN_PROPERTY_SET_OPCODE == opcode)
        {
            GENERIC_ADMIN_PROPERTY_SERVER_TRC(
                "MS_ACCESS_GENERIC_ADMIN_PROPERTY_SET_OPCODE\n");
        ...
        GENERIC_ADMIN_PROPERTY_SERVER_TRC(
            "admin_property_id 0x%04X\n", param.property_id);
        GENERIC_ADMIN_PROPERTY_SERVER_TRC(
            "admin_user_access 0x%02X\n", param.user_access);
        ...
        state_params.state_type = MS_STATE_GENERIC_ADMIN_PROPERTY_T;
    ...
    case MS_ACCESS_GENERIC_ADMIN_PROPERTY_GET_OPCODE:
    {
        GENERIC_ADMIN_PROPERTY_SERVER_TRC(
            "MS_ACCESS_GENERIC_ADMIN_PROPERTY_GET_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(generic_admin_property_get_handler);
    ...
    case MS_ACCESS_GENERIC_ADMIN_PROPERTIES_GET_OPCODE:
    {
        GENERIC_ADMIN_PROPERTY_SERVER_TRC(
            "MS_ACCESS_GENERIC_ADMIN_PROPERTIES_GET_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(generic_admin_properties_get_handler);
        /* Get Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_GET;
        req_type.to_be_acked = 0x01;
        /* Assign reqeusted state type to the application */
        state_params.state_type = MS_STATE_GENERIC_ADMIN_PROPERTY_IDS_T;
    }
    break;
    }

    /* Application callback */
    if (NULL != generic_admin_property_server_appl_cb)
    {
        generic_admin_property_server_appl_cb(&req_context, &req_raw, &req_type, &state_params, ext_params_p);
    }
...
*/
API_RESULT generic_admin_property_server_publish_timout_cb
(
    /* IN */ MS_ACCESS_MODEL_HANDLE* handle,
    /* IN */ void*                    blob
)
