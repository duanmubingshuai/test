...
#ifndef _H_GENERIC_LOCATION_SERVER_
#define _H_GENERIC_LOCATION_SERVER_
...
/* --------------------------------------------- Global Definitions */
#ifdef  GENERIC_LOCATION_SERVER_NO_DEBUG
    #define GENERIC_LOCATION_SERVER_ERR         EM_debug_null
#else /* GENERIC_LOCATION_SERVER_NO_DEBUG */
    #ifdef VAR_ARG_IN_MACRO_NOT_SUPPORTED
        #define GENERIC_LOCATION_SERVER_ERR
    #else
        #define GENERIC_LOCATION_SERVER_ERR(...)     EM_debug_error(MS_MODULE_ID_MESH_MODEL, __VA_ARGS__)
    #endif /* VAR_ARG_IN_MACRO_NOT_SUPPORTED */
#endif /* GENERIC_LOCATION_SERVER_NO_DEBUG */
#ifdef GENERIC_LOCATION_SERVER_DEBUG
    #ifdef VAR_ARG_IN_MACRO_NOT_SUPPORTED
        #define GENERIC_LOCATION_SERVER_TRC
        #define GENERIC_LOCATION_SERVER_INF
        #define GENERIC_LOCATION_SERVER_debug_dump_bytes(data, datalen)
    #else
        #define GENERIC_LOCATION_SERVER_TRC(...)     EM_debug_trace(MS_MODULE_ID_MESH_MODEL,__VA_ARGS__)
        #define GENERIC_LOCATION_SERVER_INF(...)     EM_debug_info(MS_MODULE_ID_MESH_MODEL,__VA_ARGS__)
        #define GENERIC_LOCATION_SERVER_debug_dump_bytes(data, datalen) EM_debug_dump_bytes(MS_MODULE_ID_MESH_MODEL, (data), (datalen))
    #endif /* VAR_ARG_IN_MACRO_NOT_SUPPORTED */
#else /* GENERIC_LOCATION_SERVER_DEBUG */
    #define GENERIC_LOCATION_SERVER_TRC          EM_debug_null
    #define GENERIC_LOCATION_SERVER_INF          EM_debug_null
    #define GENERIC_LOCATION_SERVER_debug_dump_bytes(data, datalen)
#endif /* GENERIC_LOCATION_SERVER_DEBUG */
