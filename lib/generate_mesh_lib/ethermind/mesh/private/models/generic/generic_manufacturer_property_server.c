...
static DECL_CONST UINT32 generic_manufacturer_property_server_opcode_list[] =
{
...
static MS_ACCESS_MODEL_HANDLE   generic_manufacturer_property_server_model_handle;
static MS_GENERIC_PROPERTY_SERVER_CB       generic_manufacturer_property_server_appl_cb;
...
)
{
    ...
    GENERIC_MANUFACTURER_PROPERTY_SERVER_TRC(
        "[GENERIC_MANUFACTURER_PROPERTY] Registered Element Handle 0x%02X\n", element_handle);
    /* Configure Model */
    model.model_id.id = MS_MODEL_ID_GENERIC_MANUFACTURER_PROPERTY_SERVER;
    model.model_id.type = MS_ACCESS_MODEL_TYPE_SIG;
    model.elem_handle = element_handle;
    /* Register Callbacks */
    model.cb = generic_manufacturer_property_server_cb;
    model.pub_cb = generic_manufacturer_property_server_publish_timout_cb;
    /* List of Opcodes */
    model.opcodes = generic_manufacturer_property_server_opcode_list;
    model.num_opcodes = sizeof(generic_manufacturer_property_server_opcode_list) / sizeof(UINT32);
    ...
    generic_manufacturer_property_server_appl_cb = appl_cb;
    /* TODO: Remove */
    generic_manufacturer_property_server_model_handle = *model_handle;
    return retval;
}
...
)
{
    ...
    marker = 0;
    GENERIC_MANUFACTURER_PROPERTY_SERVER_TRC(
        "[GENERIC_MANUFACTURER_PROPERTY_SERVER] State Update.\n");
    ...
    case MS_STATE_GENERIC_MANUFACTURER_PROPERTY_T:
    {
        ...
        param_p = (MS_STATE_GENERIC_MANUFACTURER_PROPERTY_STRUCT*)current_state_params->state;
        MS_PACK_LE_2_BYTE_VAL(&buffer[marker], param_p->property_id);
        marker += 2;

        if (MS_GENERIC_USER_ACCESS_INVALID_PROPERTY_ID != param_p->user_access)
        {
            buffer[marker] = param_p->user_access;
            marker += 1;

            if (0 != param_p->property_value_len)
            {
        ...
        GENERIC_MANUFACTURER_PROPERTY_SERVER_debug_dump_bytes(buffer, marker);
        /* Set Opcode */
        opcode = MS_ACCESS_GENERIC_MANUFACTURER_PROPERTY_STATUS_OPCODE;
    }
    break;
    ...
    case MS_STATE_GENERIC_MANUFACTURER_PROPERTY_IDS_T:
    {
        ...
        /* Set Opcode */
        opcode = MS_ACCESS_GENERIC_MANUFACTURER_PROPERTIES_STATUS_OPCODE;
    }
    break;

    default:
    {
        GENERIC_MANUFACTURER_PROPERTY_SERVER_ERR(
...
MODEL_OPCODE_HANDLER_EMPTY_DEF(generic_manufacturer_property_set_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(generic_manufacturer_property_get_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(generic_manufacturer_properties_get_handler)
...
*/
API_RESULT generic_manufacturer_property_server_cb
(
...
)
{
    ...
    MS_STATE_GENERIC_MANUFACTURER_PROPERTY_STRUCT    param;
    ...
    GENERIC_MANUFACTURER_PROPERTY_SERVER_TRC(
        "[GENERIC_MANUFACTURER_PROPERTY_SERVER] Callback. Opcode 0x%04X\n", opcode);
    GENERIC_MANUFACTURER_PROPERTY_SERVER_debug_dump_bytes(data_param, data_len);

    switch(opcode)
    {
    case MS_ACCESS_GENERIC_MANUFACTURER_PROPERTY_SET_UNACKNOWLEDGED_OPCODE: /* Fall Through */
    case MS_ACCESS_GENERIC_MANUFACTURER_PROPERTY_SET_OPCODE:
    {
        MODEL_OPCODE_HANDLER_CALL(generic_manufacturer_property_set_handler);
        /* Set Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_SET;

        if (MS_ACCESS_GENERIC_MANUFACTURER_PROPERTY_SET_OPCODE == opcode)
        {
            GENERIC_MANUFACTURER_PROPERTY_SERVER_TRC(
                "MS_ACCESS_GENERIC_MANUFACTURER_PROPERTY_SET_OPCODE\n");
        ...
        marker += 2;
        param.user_access = data_param[marker];
        marker += 1;

        /* Parameter Validation */
        if ((0x0000 == param.property_id) ||
                /* (MS_GENERIC_USER_ACCESS_READ > param.user_access) || */
                (MS_GENERIC_USER_ACCESS_READ_WRITE < param.user_access))
        {
            GENERIC_MANUFACTURER_PROPERTY_SERVER_ERR(
                "Invalid Property ID: 0x%04X. Or User Access Value: 0x%0x2X. Dropping\n",
                param.property_id, param.user_access);
            return ACCESS_INVALID_PARAMETER_VALUE;
        }
        ...
        GENERIC_MANUFACTURER_PROPERTY_SERVER_TRC(
            "manufacturer_property_id 0x%04X\n", param.property_id);
        GENERIC_MANUFACTURER_PROPERTY_SERVER_TRC(
            "manufacturer_user_access 0x%02X\n", param.user_access);
        ...
        state_params.state_type = MS_STATE_GENERIC_MANUFACTURER_PROPERTY_T;
    ...
    case MS_ACCESS_GENERIC_MANUFACTURER_PROPERTY_GET_OPCODE:
    {
        GENERIC_MANUFACTURER_PROPERTY_SERVER_TRC(
            "MS_ACCESS_GENERIC_MANUFACTURER_PROPERTY_GET_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(generic_manufacturer_property_get_handler);
    ...
    case MS_ACCESS_GENERIC_MANUFACTURER_PROPERTIES_GET_OPCODE:
    {
        GENERIC_MANUFACTURER_PROPERTY_SERVER_TRC(
            "MS_ACCESS_GENERIC_MANUFACTURER_PROPERTIES_GET_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(generic_manufacturer_properties_get_handler);
        /* Get Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_GET;
        req_type.to_be_acked = 0x01;
        /* Assign reqeusted state type to the application */
        state_params.state_type = MS_STATE_GENERIC_MANUFACTURER_PROPERTY_IDS_T;
    }
    break;
    }

    /* Application callback */
    if (NULL != generic_manufacturer_property_server_appl_cb)
    {
        generic_manufacturer_property_server_appl_cb(&req_context, &req_raw, &req_type, &state_params, ext_params_p);
    }
...
*/
API_RESULT generic_manufacturer_property_server_publish_timout_cb
(
    /* IN */ MS_ACCESS_MODEL_HANDLE* handle,
    /* IN */ void*                    blob
)
