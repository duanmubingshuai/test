...
static DECL_CONST UINT32 light_xyl_client_opcode_list[] =
{
...
static MS_ACCESS_MODEL_HANDLE   light_xyl_client_model_handle;
static MS_LIGHT_XYL_CLIENT_CB       light_xyl_client_appl_cb;
...
)
{
    ...
    LIGHT_XYL_CLIENT_TRC(
        "[LIGHT_XYL] Registered Element Handle 0x%02X\n", element_handle);
    /* Configure Model */
    model.model_id.id = MS_MODEL_ID_LIGHT_XYL_CLIENT;
    model.model_id.type = MS_ACCESS_MODEL_TYPE_SIG;
    model.elem_handle = element_handle;
    /* Register Callbacks */
    model.cb = light_xyl_client_cb;
    model.pub_cb = NULL;
    /* List of Opcodes */
    model.opcodes = light_xyl_client_opcode_list;
    model.num_opcodes = sizeof(light_xyl_client_opcode_list) / sizeof(UINT32);
    ...
    light_xyl_client_appl_cb = appl_cb;
    /* TODO: Remove */
    light_xyl_client_model_handle = *model_handle;
    return retval;
}
...
)
{
    ...
    marker = 0;
    LIGHT_XYL_CLIENT_TRC(
        "[LIGHT_XYL_CLIENT] Send Reliable PDU. Req Opcode 0x%08X, Rsp Opcode 0x%08X\n",
    ...
    {
        MS_LIGHT_XYL_DEFAULT_SET_STRUCT* param_p;
        LIGHT_XYL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_XYL_DEFAULT_SET_OPCODE\n");
        param_p = (MS_LIGHT_XYL_DEFAULT_SET_STRUCT*) param;
    ...
    case MS_ACCESS_LIGHT_XYL_DEFAULT_SET_UNACKNOWLEDGED_OPCODE:
    {
        MS_LIGHT_XYL_DEFAULT_SET_STRUCT* param_p;
        LIGHT_XYL_CLIENT_TRC(
    ...
    {
        MS_LIGHT_XYL_RANGE_SET_STRUCT* param_p;
        LIGHT_XYL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_XYL_RANGE_SET_OPCODE\n");
        param_p = (MS_LIGHT_XYL_RANGE_SET_STRUCT*) param;
    ...
    case MS_ACCESS_LIGHT_XYL_RANGE_SET_UNACKNOWLEDGED_OPCODE:
    {
        MS_LIGHT_XYL_RANGE_SET_STRUCT* param_p;
        LIGHT_XYL_CLIENT_TRC(
    ...
    {
        MS_LIGHT_XYL_SET_STRUCT* param_p;
        LIGHT_XYL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_XYL_SET_OPCODE\n");
        param_p = (MS_LIGHT_XYL_SET_STRUCT*) param;
    ...
    case MS_ACCESS_LIGHT_XYL_SET_UNACKNOWLEDGED_OPCODE:
    {
        MS_LIGHT_XYL_SET_STRUCT* param_p;
        LIGHT_XYL_CLIENT_TRC(
...
{
    /* Fill Model Handle */
    * model_handle = light_xyl_client_model_handle;
    return API_SUCCESS;
}

/* Empty Model Opcode Handler Defines */
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_xyl_default_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_xyl_range_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_xyl_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_xyl_target_status_handler)
...
*/
API_RESULT light_xyl_client_cb
(
...
)
{
    ...
    LIGHT_XYL_CLIENT_debug_dump_bytes(data_param, data_len);
    ...
    case MS_ACCESS_LIGHT_XYL_DEFAULT_STATUS_OPCODE:
    {
        LIGHT_XYL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_XYL_DEFAULT_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_xyl_default_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_XYL_RANGE_STATUS_OPCODE:
    {
        LIGHT_XYL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_XYL_RANGE_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_xyl_range_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_XYL_STATUS_OPCODE:
    {
        LIGHT_XYL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_XYL_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_xyl_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_XYL_TARGET_STATUS_OPCODE:
    {
        LIGHT_XYL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_XYL_TARGET_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_xyl_target_status_handler);
    }
    break;
    }

    /* Application callback */
    if (NULL != light_xyl_client_appl_cb)
    {
        light_xyl_client_appl_cb(handle, opcode, data_param, data_len);
    }
