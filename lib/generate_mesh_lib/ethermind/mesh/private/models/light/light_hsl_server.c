...
static DECL_CONST UINT32 light_hsl_server_opcode_list[] =
{
...
static DECL_CONST UINT32 light_hsl_setup_server_opcode_list[] =
{
...
static MS_ACCESS_MODEL_HANDLE   light_hsl_server_model_handle;
static MS_ACCESS_MODEL_HANDLE   light_hsl_setup_server_model_handle;
static MS_LIGHT_HSL_SERVER_CB   light_hsl_server_appl_cb;
...
)
{
    ...
    LIGHT_HSL_SERVER_TRC(
        "[LIGHT_HSL] Registered Element Handle 0x%02X\n", element_handle);
    /* Configure Model */
    model.model_id.id = MS_MODEL_ID_LIGHT_HSL_SERVER;
    model.model_id.type = MS_ACCESS_MODEL_TYPE_SIG;
    model.elem_handle = element_handle;
    /* Register Callbacks */
    model.cb = light_hsl_server_cb;
    model.pub_cb = light_hsl_server_publish_timout_cb;
    /* List of Opcodes */
    model.opcodes = light_hsl_server_opcode_list;
    model.num_opcodes = sizeof(light_hsl_server_opcode_list) / sizeof(UINT32);
    ...
    /* Configure Model */
    model.model_id.id = MS_MODEL_ID_LIGHT_HSL_SETUP_SERVER;
    model.model_id.type = MS_ACCESS_MODEL_TYPE_SIG;
    model.elem_handle = element_handle;
    /* Register Callbacks */
    model.cb = light_hsl_server_cb;
    model.pub_cb = light_hsl_server_publish_timout_cb;
    /* List of Opcodes */
    model.opcodes = light_hsl_setup_server_opcode_list;
    model.num_opcodes = sizeof(light_hsl_setup_server_opcode_list) / sizeof(UINT32);
    retval = MS_access_register_model
             (
                 node_id,
                 &model,
                 hsl_setup_model_handle
             );
    /* Save Application Callback */
    light_hsl_server_appl_cb = appl_cb;
    /* TODO: Remove */
    light_hsl_server_model_handle = *hsl_model_handle;
    light_hsl_setup_server_model_handle = *hsl_setup_model_handle;
    return retval;
}
...
)
{
    ...
    case MS_STATE_LIGHT_HSL_RANGE_T:
    {
        ...
        param_p = (MS_STATE_LIGHT_HSL_RANGE_STRUCT*)current_state_params->state;
        ...
        marker += 2;
        /* Set Opcode */
        opcode = MS_ACCESS_LIGHT_HSL_RANGE_STATUS_OPCODE;
    }
    break;
    ...
    case MS_STATE_LIGHT_HSL_TARGET_T:
    {
        ...
        param_p = (MS_STATE_LIGHT_HSL_STRUCT*)current_state_params->state;
        MS_PACK_LE_2_BYTE_VAL(&buffer[marker], param_p->target_hsl_lightness);
        marker += 2;
        MS_PACK_LE_2_BYTE_VAL(&buffer[marker], param_p->target_hsl_hue);
        marker += 2;
        MS_PACK_LE_2_BYTE_VAL(&buffer[marker], param_p->target_hsl_saturation);
        marker += 2;
        ...
        /* Set Opcode */
        opcode = MS_ACCESS_LIGHT_HSL_TARGET_STATUS_OPCODE;
    }
    break;
    ...
    case MS_STATE_LIGHT_HSL_T:
    {
        ...
        /* Set Opcode */
        opcode = MS_ACCESS_LIGHT_HSL_STATUS_OPCODE;
    }
    break;
    ...
    case MS_STATE_LIGHT_HSL_DEFAULT_T:
    {
        ...
        param_p = (MS_STATE_LIGHT_HSL_DEFAULT_STRUCT*)current_state_params->state;
        MS_PACK_LE_2_BYTE_VAL(&buffer[marker], param_p->hsl_lightness);
        marker += 2;
        MS_PACK_LE_2_BYTE_VAL(&buffer[marker], param_p->hsl_hue);
        marker += 2;
        ...
        marker += 2;
        /* Set Opcode */
        opcode = MS_ACCESS_LIGHT_HSL_DEFAULT_STATUS_OPCODE;
    }
    break;

    default:
    {
        LIGHT_HSL_SERVER_ERR(
...
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_range_get_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_set_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_default_get_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_get_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_target_get_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_default_set_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_range_set_handler)
...
*/
API_RESULT light_hsl_server_cb
(
...
)
{
    ...
    LIGHT_HSL_SERVER_TRC(
        "[LIGHT_HSL_SERVER] Callback. Opcode 0x%04X\n", opcode);
    LIGHT_HSL_SERVER_debug_dump_bytes(data_param, data_len);

    switch(opcode)
    {
    case MS_ACCESS_LIGHT_HSL_SET_UNACKNOWLEDGED_OPCODE: /* Fall Through */
    case MS_ACCESS_LIGHT_HSL_SET_OPCODE:
    {
        MODEL_OPCODE_HANDLER_CALL(light_hsl_set_handler);
        /* Set Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_SET;

        if (MS_ACCESS_LIGHT_HSL_SET_OPCODE == opcode)
        {
            LIGHT_HSL_SERVER_TRC(
                "MS_ACCESS_LIGHT_HSL_SET_OPCODE\n");
        ...
        /* Decode Parameters */
        marker = 0;
        MS_UNPACK_LE_2_BYTE(&param.hsl_lightness, &data_param[marker]);
        marker += 2;
        MS_UNPACK_LE_2_BYTE(&param.hsl_hue, &data_param[marker]);
        marker += 2;
        MS_UNPACK_LE_2_BYTE(&param.hsl_saturation, &data_param[marker]);
        marker += 2;
        param.tid = data_param[marker];
        marker += 1;
        LIGHT_HSL_SERVER_TRC(
            "hsl_lightness 0x%04X\n", param.hsl_lightness);
        LIGHT_HSL_SERVER_TRC(
            "hsl_hue 0x%04X\n", param.hsl_hue);
        LIGHT_HSL_SERVER_TRC(
            "hsl_saturation 0x%04X\n", param.hsl_saturation);
        LIGHT_HSL_SERVER_TRC("TID 0x%04X\n", param.tid);
        ...
        state_params.state_type = MS_STATE_LIGHT_HSL_T;
    ...
    case MS_ACCESS_LIGHT_HSL_RANGE_GET_OPCODE:
    {
        LIGHT_HSL_SERVER_TRC(
            "MS_ACCESS_LIGHT_HSL_RANGE_GET_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_hsl_range_get_handler);
        /* Get Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_GET;
        req_type.to_be_acked = 0x01;
        /* Assign reqeusted state type to the application */
        state_params.state_type = MS_STATE_LIGHT_HSL_RANGE_T;
    }
    break;
    ...
    case MS_ACCESS_LIGHT_HSL_DEFAULT_GET_OPCODE:
    {
        LIGHT_HSL_SERVER_TRC(
            "MS_ACCESS_LIGHT_HSL_DEFAULT_GET_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_hsl_default_get_handler);
        /* Get Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_GET;
        req_type.to_be_acked = 0x01;
        /* Assign reqeusted state type to the application */
        state_params.state_type = MS_STATE_LIGHT_HSL_DEFAULT_T;
    }
    break;
    ...
    case MS_ACCESS_LIGHT_HSL_GET_OPCODE:
    {
        LIGHT_HSL_SERVER_TRC(
            "MS_ACCESS_LIGHT_HSL_GET_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_hsl_get_handler);
        /* Get Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_GET;
        req_type.to_be_acked = 0x01;
        /* Assign reqeusted state type to the application */
    ...
    case MS_ACCESS_LIGHT_HSL_TARGET_GET_OPCODE:
    {
        LIGHT_HSL_SERVER_TRC(
            "MS_ACCESS_LIGHT_HSL_TARGET_GET_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_hsl_target_get_handler);
        /* Get Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_GET;
        req_type.to_be_acked = 0x01;
        /* Assign reqeusted state type to the application */
        state_params.state_type = MS_STATE_LIGHT_HSL_TARGET_T;
    }
    break;

    case MS_ACCESS_LIGHT_HSL_DEFAULT_SET_UNACKNOWLEDGED_OPCODE: /* Fall Through */
    case MS_ACCESS_LIGHT_HSL_DEFAULT_SET_OPCODE:
    {
        MODEL_OPCODE_HANDLER_CALL(light_hsl_default_set_handler);
        /* Set Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_SET;

        if (MS_ACCESS_LIGHT_HSL_DEFAULT_SET_OPCODE == opcode)
        {
            LIGHT_HSL_SERVER_TRC(
                "MS_ACCESS_LIGHT_HSL_DEFAULT_SET_OPCODE\n");
            req_type.to_be_acked = 0x01;
        ...
        /* Decode Parameters */
        marker = 0;
        MS_UNPACK_LE_2_BYTE(&param_default.hsl_lightness, &data_param[marker]);
        marker += 2;
        MS_UNPACK_LE_2_BYTE(&param_default.hsl_hue, &data_param[marker]);
        marker += 2;
        MS_UNPACK_LE_2_BYTE(&param_default.hsl_saturation, &data_param[marker]);
        marker += 2;
        LIGHT_HSL_SERVER_TRC(
            "hsl_lightness 0x%04X\n", param_default.hsl_lightness);
        LIGHT_HSL_SERVER_TRC(
            "hsl_hue 0x%04X\n", param_default.hsl_hue);
        LIGHT_HSL_SERVER_TRC(
            "hsl_saturation 0x%04X\n", param_default.hsl_saturation);
        /* Parameter Validation */
        /* Assign decoded state parameter to provide to application */
        state_params.state_type = MS_STATE_LIGHT_HSL_DEFAULT_T;
    ...
    case MS_ACCESS_LIGHT_HSL_RANGE_SET_UNACKNOWLEDGED_OPCODE: /* Fall Through */
    case MS_ACCESS_LIGHT_HSL_RANGE_SET_OPCODE:
    {
        MODEL_OPCODE_HANDLER_CALL(light_hsl_range_set_handler);
        /* Set Request Type */
        req_type.type = MS_ACCESS_MODEL_REQ_MSG_T_SET;

        if (MS_ACCESS_LIGHT_HSL_RANGE_SET_OPCODE == opcode)
        {
            LIGHT_HSL_SERVER_TRC(
                "MS_ACCESS_LIGHT_HSL_RANGE_SET_OPCODE\n");
            req_type.to_be_acked = 0x01;
        ...
        /* Decode Parameters */
        marker = 0;
        MS_UNPACK_LE_2_BYTE(&param_range.hue_range_min, &data_param[marker]);
        marker += 2;
        MS_UNPACK_LE_2_BYTE(&param_range.hue_range_max, &data_param[marker]);
        marker += 2;
        MS_UNPACK_LE_2_BYTE(&param_range.saturation_range_min, &data_param[marker]);
        marker += 2;
        MS_UNPACK_LE_2_BYTE(&param_range.saturation_range_max, &data_param[marker]);
        marker += 2;
        LIGHT_HSL_SERVER_TRC(
            "hue_range_min 0x%04X\n", param_range.hue_range_min);
        LIGHT_HSL_SERVER_TRC(
            "hue_range_max 0x%04X\n", param_range.hue_range_max);
        LIGHT_HSL_SERVER_TRC(
            "saturation_range_min 0x%04X\n", param_range.saturation_range_min);
        LIGHT_HSL_SERVER_TRC(
            "saturation_range_max 0x%04X\n", param_range.saturation_range_max);

        /* Parameter Validation */
        if ((param_range.hue_range_min > param_range.hue_range_max) ||
                (param_range.saturation_range_min > param_range.saturation_range_max))
        {
            ...
            */
            LIGHT_HSL_SERVER_ERR("hue/saturation MIN/MAX out of range. Dropping...\n");
    ...
    if (NULL != light_hsl_server_appl_cb)
    {
        light_hsl_server_appl_cb(&req_context, &req_raw, &req_type, &state_params, ext_params_p);
    }
...
*/
API_RESULT light_hsl_server_publish_timout_cb
(
    /* IN */ MS_ACCESS_MODEL_HANDLE* handle,
    /* IN */ void*                    blob
)
