...
static DECL_CONST UINT32 light_hsl_client_opcode_list[] =
{
...
static MS_ACCESS_MODEL_HANDLE   light_hsl_client_model_handle;
static MS_LIGHT_HSL_CLIENT_CB       light_hsl_client_appl_cb;
...
)
{
    ...
    LIGHT_HSL_CLIENT_TRC(
        "[LIGHT_HSL] Registered Element Handle 0x%02X\n", element_handle);
    /* Configure Model */
    model.model_id.id = MS_MODEL_ID_LIGHT_HSL_CLIENT;
    model.model_id.type = MS_ACCESS_MODEL_TYPE_SIG;
    model.elem_handle = element_handle;
    /* Register Callbacks */
    model.cb = light_hsl_client_cb;
    model.pub_cb = NULL;
    /* List of Opcodes */
    model.opcodes = light_hsl_client_opcode_list;
    model.num_opcodes = sizeof(light_hsl_client_opcode_list) / sizeof(UINT32);
    ...
    light_hsl_client_appl_cb = appl_cb;
    /* TODO: Remove */
    light_hsl_client_model_handle = *model_handle;
    return retval;
}
...
)
{
    ...
    marker = 0;
    LIGHT_HSL_CLIENT_TRC(
        "[LIGHT_HSL_CLIENT] Send Reliable PDU. Req Opcode 0x%08X, Rsp Opcode 0x%08X\n",
...
{
    /* Fill Model Handle */
    * model_handle = light_hsl_client_model_handle;
    return API_SUCCESS;
}

/* Empty Model Opcode Handler Defines */
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_default_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_hue_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_range_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_saturation_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_hsl_target_status_handler)
...
*/
API_RESULT light_hsl_client_cb
(
...
)
{
    ...
    LIGHT_HSL_CLIENT_debug_dump_bytes(data_param, data_len);
    ...
    case MS_ACCESS_LIGHT_HSL_DEFAULT_STATUS_OPCODE:
    {
        LIGHT_HSL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_HSL_DEFAULT_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_hsl_default_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_HSL_HUE_STATUS_OPCODE:
    {
        LIGHT_HSL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_HSL_HUE_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_hsl_hue_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_HSL_RANGE_STATUS_OPCODE:
    {
        LIGHT_HSL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_HSL_RANGE_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_hsl_range_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_HSL_SATURATION_STATUS_OPCODE:
    {
        LIGHT_HSL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_HSL_SATURATION_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_hsl_saturation_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_HSL_STATUS_OPCODE:
    {
        LIGHT_HSL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_HSL_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_hsl_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_HSL_TARGET_STATUS_OPCODE:
    {
        LIGHT_HSL_CLIENT_TRC(
            "MS_ACCESS_LIGHT_HSL_TARGET_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_hsl_target_status_handler);
    }
    break;
    }

    /* Application callback */
    if (NULL != light_hsl_client_appl_cb)
    {
        light_hsl_client_appl_cb(handle, opcode, data_param, data_len);
    }
