...
static DECL_CONST UINT32 light_lc_client_opcode_list[] =
{
...
static MS_ACCESS_MODEL_HANDLE   light_lc_client_model_handle;
static MS_LIGHT_LC_CLIENT_CB       light_lc_client_appl_cb;
...
)
{
    ...
    /* Configure Model */
    model.model_id.id = MS_MODEL_ID_LIGHT_LC_CLIENT;
    model.model_id.type = MS_ACCESS_MODEL_TYPE_SIG;
    model.elem_handle = element_handle;
    /* Register Callbacks */
    model.cb = light_lc_client_cb;
    model.pub_cb = NULL;
    /* List of Opcodes */
    model.opcodes = light_lc_client_opcode_list;
    model.num_opcodes = sizeof(light_lc_client_opcode_list) / sizeof(UINT32);
    ...
    light_lc_client_appl_cb = appl_cb;
    /* TODO: Remove */
    light_lc_client_model_handle = *model_handle;
    return retval;
}
...
)
{
    ...
    marker = 0;
    LIGHT_LC_CLIENT_TRC(
        "[LIGHT_LC_CLIENT] Send Reliable PDU. Req Opcode 0x%08X, Rsp Opcode 0x%08X\n",
    ...
    {
        MS_LIGHT_LC_LIGHT_ONOFF_SET_STRUCT* param_p;
        LIGHT_LC_CLIENT_TRC(
            "MS_ACCESS_LIGHT_LC_LIGHT_ONOFF_SET_OPCODE\n");
        param_p = (MS_LIGHT_LC_LIGHT_ONOFF_SET_STRUCT*) param;
        buffer[marker] = param_p->light_onoff;
        marker += 1;
    ...
    case MS_ACCESS_LIGHT_LC_LIGHT_ONOFF_SET_UNACKNOWLEDGED_OPCODE:
    {
        MS_LIGHT_LC_LIGHT_ONOFF_SET_STRUCT* param_p;
        LIGHT_LC_CLIENT_TRC(
    ...
    {
        MS_LIGHT_LC_MODE_STRUCT* param_p;
        LIGHT_LC_CLIENT_TRC(
            "MS_ACCESS_LIGHT_LC_MODE_SET_OPCODE\n");
        param_p = (MS_LIGHT_LC_MODE_STRUCT*) param;
        buffer[marker] = param_p->mode;
        marker += 1;
    }
    break;

    case MS_ACCESS_LIGHT_LC_MODE_SET_UNACKNOWLEDGED_OPCODE:
    {
        MS_LIGHT_LC_MODE_STRUCT* param_p;
        LIGHT_LC_CLIENT_TRC(
    ...
    {
        MS_LIGHT_LC_OM_STRUCT* param_p;
        LIGHT_LC_CLIENT_TRC(
            "MS_ACCESS_LIGHT_LC_OM_SET_OPCODE\n");
        param_p = (MS_LIGHT_LC_OM_STRUCT*) param;
        buffer[marker] = param_p->mode;
        marker += 1;
    }
    break;

    case MS_ACCESS_LIGHT_LC_OM_SET_UNACKNOWLEDGED_OPCODE:
    {
        MS_LIGHT_LC_OM_STRUCT* param_p;
        LIGHT_LC_CLIENT_TRC(
    ...
    {
        MS_LIGHT_LC_PROPERTY_GET_STRUCT* param_p;
        LIGHT_LC_CLIENT_TRC(
            "MS_ACCESS_LIGHT_LC_PROPERTY_GET_OPCODE\n");
        param_p = (MS_LIGHT_LC_PROPERTY_GET_STRUCT*) param;
        MS_PACK_LE_2_BYTE_VAL(&buffer[marker], param_p->light_lc_property_id);
        marker += 2;
    }
    break;
    ...
    {
        MS_LIGHT_LC_PROPERTY_SET_STRUCT* param_p;
        LIGHT_LC_CLIENT_TRC(
            "MS_ACCESS_LIGHT_LC_PROPERTY_SET_OPCODE\n");
        param_p = (MS_LIGHT_LC_PROPERTY_SET_STRUCT*) param;
        MS_PACK_LE_2_BYTE_VAL(&buffer[marker], param_p->light_lc_property_id);
        marker += 2;
        EM_mem_copy(&buffer[marker], param_p->light_lc_property_value, param_p->light_lc_property_value_len);
        marker += param_p->light_lc_property_value_len;
    }
    break;

    case MS_ACCESS_LIGHT_LC_PROPERTY_SET_UNACKNOWLEDGED_OPCODE:
    {
        MS_LIGHT_LC_PROPERTY_SET_STRUCT* param_p;
        LIGHT_LC_CLIENT_TRC(
...
{
    /* Fill Model Handle */
    * model_handle = light_lc_client_model_handle;
    return API_SUCCESS;
}

/* Empty Model Opcode Handler Defines */
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_lc_light_onoff_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_lc_mode_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_lc_om_status_handler)
MODEL_OPCODE_HANDLER_EMPTY_DEF(light_lc_property_status_handler)
...
)
{
    ...
    LIGHT_LC_CLIENT_debug_dump_bytes(data_param, data_len);
    ...
    case MS_ACCESS_LIGHT_LC_LIGHT_ONOFF_STATUS_OPCODE:
    {
        LIGHT_LC_CLIENT_TRC(
            "MS_ACCESS_LIGHT_LC_LIGHT_ONOFF_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_lc_light_onoff_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_LC_MODE_STATUS_OPCODE:
    {
        LIGHT_LC_CLIENT_TRC(
            "MS_ACCESS_LIGHT_LC_MODE_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_lc_mode_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_LC_OM_STATUS_OPCODE:
    {
        LIGHT_LC_CLIENT_TRC(
            "MS_ACCESS_LIGHT_LC_OM_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_lc_om_status_handler);
    }
    break;
    ...
    case MS_ACCESS_LIGHT_LC_PROPERTY_STATUS_OPCODE:
    {
        LIGHT_LC_CLIENT_TRC(
            "MS_ACCESS_LIGHT_LC_PROPERTY_STATUS_OPCODE\n");
        MODEL_OPCODE_HANDLER_CALL(light_lc_property_status_handler);
    }
    break;
    }

    /* Application callback */
    if (NULL != light_lc_client_appl_cb)
    {
        light_lc_client_appl_cb(handle, opcode, data_param, data_len);
    }
