...
//  L2CAP_SetControllerToHostFlowCtrl( (uint16)(MAXMEMHEAP/3), flowCtrlMode );
//}
...
//	#ifdef _PHY_DEBUG 
//		  LOG("%s,%s,Line %d,pkt.method 0x%X,status %d\n",__FILE__,__func__,__LINE__,pkt.method,status);
//	#endif
