...
bool finidv()
{
    ...
    LL_ENC_AES128_Encrypt((uint8_t* )temp_sec_key, (uint8_t* ) pCHIP_SECURE_PLAINTEXT, (uint8_t* ) cyr_out);
    ...
    LL_ENC_AES128_Encrypt((uint8_t* )temp_sec_key, (uint8_t* ) pCHIP_SECURE_MIC, (uint8_t* ) g_ota_sec_key);
    efuse[0] = 0;
    efuse[1] = 0;
