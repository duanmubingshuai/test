...
#define LCD_LED hal_gpio_write(P34, 1) //LCD背光             PB9
//如果使用官方库函数定义下列底层，速度将会下降到14帧每秒，建议采用我司推荐方法
//以下IO定义直接操作寄存器，快速IO操作，刷屏速率可以达到28帧每秒！

//GPIO置位（拉高）
//#define   LCD_CS_SET  GPIO_TYPE->BSRR=1<<LCD_CS    //片选端口     PB11
#define LCD_RS_SET  hal_gpio_write(P31, 1)    //数据/命令  PB10   
#define LCD_RST_SET hal_gpio_write(P26, 1);   //复位              PB12

//GPIO复位（拉低）
//#define   LCD_CS_CLR  GPIO_TYPE->BRR=1<<LCD_CS     //片选端口     PB11
#define LCD_RS_CLR  hal_gpio_write(P31, 0)     //数据/命令  PB10     
#define LCD_RST_CLR hal_gpio_write(P26, 0)    //复位              PB12
