...
bool xmdm_cb(int rsp, xmdm_cb_param_t* param)
{
    return xmdm_data_callback_default(rsp, param);
}
...
void cons_callback(uint16_t cmd_id, uint8_t argc, char** argv)
{
    ...
    {
    case 1:
        xmit_size = strtol(argv[0], NULL, 16);
        xmodem_service_xmit(UART1, 115200, P24, P25, xmit_size, xmdm_cb);
        break;
