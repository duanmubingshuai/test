...
#define   BLE_MAX_ALLOW_PKT_PER_EVENT_TX        4//3
#define   BLE_MAX_ALLOW_PKT_PER_EVENT_RX        4

#define   BLE_PKT_VERSION                       BLE_PKT_VERSION_5_1//BLE_PKT_VERSION_4_0 //BLE_PKT_VERSION_5_1 //BLE_PKT_VERSION_5_1     
...
int  main(void)
{
    ...
    LOG("BLE_PKT_VERSION:%d\n",BLE_PKT_VERSION);
    LOG("BLE_PKT_BUF_SIZE:%d\n",BLE_PKT_BUF_SIZE);
    app_main();
}
