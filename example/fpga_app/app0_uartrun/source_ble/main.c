...
void init_config(void)
{
    ...
    pGlobal_config[CLK_TRACKING_CONFIG_DLL ] = 0x000a01f4;//[23:16] settle_thd [11:0] target_cnt
    pGlobal_config[CLK_TRACKING_CONFIG_XTAL] = 0x000a00fa;//[23:16] settle_thd [11:0] target_cnt
