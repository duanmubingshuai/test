...
#define UART_INPUT1_EVT                               0x0002  //for touch key event
#define UART_INPUT_EVT                                0x0004  //for touch key event
#define TOUCH_PRESS_EVT                               0x0008  //for touch key event
#define RX_TIMEOUT_EVT                                0x0010
#define TX_COMPLETED_EVT                              0x0020
#define SPI_TX_TEST_EVT                               0x0100
